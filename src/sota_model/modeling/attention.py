...
GQA at an 8:1 group ratio (UltraModel 5: 144 Q / 18 KV heads; 4.7-class:
128 / 16) is the trick that makes 1M-context shippable — without it the
UltraModel 5 KV cache at 1M would be ~9 TiB instead of 1152 GiB bf16.
